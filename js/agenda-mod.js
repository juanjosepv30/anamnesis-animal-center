...
(function(){
  ...
  function mount(el, opts){
    ...
    function guardarCita(manual){
      ...
      if(_exigeComprobante() && !fileP){ err.textContent='Suba el comprobante de pago — con la Dra. Marisol, la consulta/control especializado no se agenda sin él.'; return; }
